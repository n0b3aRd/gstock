    ...
    <div class="flex flex-col overflow-y-auto md:flex-row">
      ...
      <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
        <form @submit.prevent="submit" class="w-full">
          ...
          <label class="block mt-4 text-sm">
            <label for="password_confirmation" class="text-gray-700 dark:text-gray-400"> Confirm password </label>
            <input
          ...
          <p class="mt-4">
            <Link :href="route('login')" class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline">
