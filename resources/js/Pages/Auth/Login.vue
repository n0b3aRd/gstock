      ...
      <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
        <form @submit.prevent="submit" class="w-full">
          ...
          <label class="block text-sm">
            <label for="email" class="text-gray-700 dark:text-gray-400">Email</label>
            <input
              type="email"
              id="email"
...
<!--          </button>-->
          <p class="mt-4">
            <Link v-if="canResetPassword" :href="route('password.request')" class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline">
              Forgot your password?
            </Link>
          </p>
          <p class="mt-1">
            <Link :href="route('register')" class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" href="./create-account.html">
              Create account
            </Link>
          </p>
        </form>
